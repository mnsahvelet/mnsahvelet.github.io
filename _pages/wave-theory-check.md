<div class="wrap" style="max-width:980px;margin:0 auto;">
  ...
  <div class="panel" style="display:grid;grid-template-columns:320px 1fr;gap:14px;align-items:start;">
    ...
    <div class="card" style="background:#1b1b1b;border:1px solid #333;border-radius:12px;padding:12px;">
      <canvas id="chart" width="980" height="520" style="width:100%;height:520px;background:#0f0f0f;border-radius:12px;border:1px solid #333;"></canvas>
    </div>
  </div>
</div>
